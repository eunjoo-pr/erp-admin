  ...
  return (
    <Dropdown isOpen={isOpen} setIsOpen={setIsOpen}>
      ...
      >
        <button
          onClick={handleClose}
          className="flex w-full items-center gap-2 rounded-md px-2.5 py-2.25 text-left font-medium text-dark-4 hover:bg-gray-2 hover:text-dark dark:text-dark-6 dark:hover:bg-dark-3 dark:hover:text-white"
        >
          <PencilSquareIcon />
          Edit
        </button>
        ...
        <button
          onClick={handleClose}
          className="flex w-full items-center gap-2 rounded-lg px-2.5 py-2.25 text-left font-medium text-dark-4 hover:bg-gray-2 hover:text-dark dark:text-dark-6 dark:hover:bg-dark-3 dark:hover:text-white"
        >
          <TrashIcon />
          Delete
        </button>
