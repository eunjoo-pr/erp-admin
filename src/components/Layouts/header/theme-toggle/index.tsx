...
export function ThemeToggleSwitch() {
  ...
  return (
    <button
      ...
      className="group cursor-pointer rounded-full bg-gray-3 p-1.25 text-dark outline-0 focus-visible:outline focus-visible:outline-primary dark:bg-[#020D1A] dark:text-current"
    >
