...
const SettingBoxes = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (updatedUser) {
      // Better Auth exposes `refetch`; the old NextAuth `update()` helper is gone.
      await refetch();
            ...
            <div className="p-7">
              <form onSubmit={handleSubmit}>
                <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      <span className="absolute top-1/2 left-4.5 -translate-y-1/2">
                        <UserIcon />
                      </span>
                      <input
                        className="w-full rounded-lg border-[1.5px] border-stroke bg-white py-2.5 pr-4.5 pl-12.5 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                        type="text"
                        name="fullName"
                        id="fullName"
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    <span className="absolute top-5.5 left-5">
                      <PencilSquareIcon width={20} height={20} />
                    </span>

                    <textarea
                      className="w-full rounded-lg border-[1.5px] border-stroke bg-white py-5 pr-5 pl-13 text-dark focus:border-primary focus-visible:outline-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                      name="bio"
                      id="bio"
                      rows={6}
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    className="hover:bg-opacity-90 flex justify-center rounded-lg bg-primary px-6 py-1.75 font-medium text-gray-2"
                    type="submit"
                  >
                    {loading ? (
          ...
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            ...
            <div className="p-7">
              <form onSubmit={handleSubmit}>
                ...
                <div
                  id="FileUpload"
                  className="relative mb-5.5 block w-full cursor-pointer appearance-none rounded-xl border border-dashed border-gray-4 bg-gray-2 px-4 py-4 hover:border-primary sm:py-7.5 dark:border-dark-3 dark:bg-dark-2 dark:hover:border-primary"
                >
                  <input
                    type="file"
                    name="profilePhoto"
