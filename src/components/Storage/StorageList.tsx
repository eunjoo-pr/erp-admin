...
import { DocumentIcon } from "@/app/(site)/(with-layout)/pages/file-manager/_components/icons";
...
const StorageList: React.FC = () => {
  ...
  return (
    <div className="grow space-y-5 rounded-[10px] bg-white p-4 shadow-1 md:p-6 xl:p-8 dark:bg-gray-dark dark:shadow-card">
