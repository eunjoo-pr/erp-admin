  ...
  return (
    <div className="rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
      <div className="flex flex-col gap-2 p-4 sm:flex-row sm:justify-between md:p-6 xl:p-7.5">
        <h2 className="text-[26px] leading-7.5 font-bold text-dark dark:text-white">
          Activity Chart
        </h2>
        <div className="flex items-center gap-2.5">
          <p className="font-medium text-dark uppercase dark:text-white">
            Sort by:
          </p>
