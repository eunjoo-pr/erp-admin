...
export function FeaturedCampaigns() {
  ...
  return (
    <div className="col-span-12 rounded-[10px] bg-white shadow-1 xl:col-span-6 dark:bg-gray-dark dark:shadow-card">
      <div className="flex items-start justify-between border-b border-stroke px-6 pt-5 pb-4 dark:border-dark-3">
        <div>
