...
export async function TopChannels() {
  ...
  return (
    <div className="rounded-[10px] bg-white p-4 shadow-1 sm:p-6 xl:p-7.5 dark:bg-gray-dark dark:shadow-card">
          ...
          return (
            <div key={index} className="grid grid-cols-10 [&>div]:py-2">
              <div className="relative z-1 col-span-8 grid grid-cols-8">
                <div
                  className="absolute top-0 left-0 -z-1 h-full rounded bg-gray-2 dark:bg-[#FFFFFF1A]"
