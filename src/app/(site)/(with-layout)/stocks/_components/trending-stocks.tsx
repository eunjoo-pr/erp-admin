...
function Button({
  ...
  return (
    <button
      className={cn(
        "flex w-full items-center justify-center rounded-[5px] bg-[#F3F5F8] px-7.5 py-2 text-body-sm font-medium text-dark hover:bg-primary/15 hover:text-primary dark:bg-dark-2 dark:text-white dark:hover:bg-primary/15 dark:hover:text-primary",
        className,
      )}
    >
      {children}
