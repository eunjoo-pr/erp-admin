import { PolygonUp } from "@/app/(site)/(with-layout)/stocks/_components/icons";
...
export async function MyStocks(props: { timeFrame?: string }) {
  ...
  return (
    <div className="col-span-12 overflow-hidden rounded-[10px] bg-white shadow-1 xl:col-span-5 dark:bg-gray-dark">
          ...
          >
            <figure className="flex items-center gap-3">
              ...
              <figcaption className="text-sm">
                <div className="leading-6 font-bold text-dark dark:text-white">
                  {item.name}
                </div>
