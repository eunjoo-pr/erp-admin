...
export default function Page() {
  return (
    <div className="relative z-10 overflow-hidden bg-white px-4 sm:px-8 dark:bg-gray-dark">
      <div className="flex h-screen flex-col items-center justify-center overflow-hidden">
        <div className="no-scrollbar overflow-y-auto py-20">
          ...
          {/* <!-- form start --> */}
          <div className="mx-auto mt-12.5 w-full max-w-145">
            <form>
              <div className="flex">
                <input
                  type="email"
                  ...
                  required
                  className="w-full rounded-l-lg border-[1.5px] border-r-0 border-stroke bg-transparent px-5.5 py-3 text-dark transition outline-none placeholder:text-dark-4 focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:placeholder:text-dark-6 dark:focus:border-primary"
                />
                <button className="hover:bg-opacity-90 inline-flex justify-center rounded-r-lg bg-primary px-4 py-3 font-medium text-white duration-200 ease-out sm:px-7.5">
                  Subscribe
                </button>
              </div>
            </form>
      ...
      <div className="absolute top-0 left-0 -z-10 flex h-screen w-full items-center justify-around">
